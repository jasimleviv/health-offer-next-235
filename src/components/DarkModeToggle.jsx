...
export default function DarkModeToggle() {
  ...
  return (
    <button
      ...
      title={`Theme: ${theme}`}
      className={`fixed bottom-2 left-2 z-50 grid h-8 w-8 place-items-center rounded-full border opacity-70 shadow-lg backdrop-blur transition hover:opacity-90 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-emerald-500 sm:bottom-4 sm:left-4 ${
        isAutoMode
